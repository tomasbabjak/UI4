...
public class MnistClassifierUI extends Application {
    ...
    private void predictImage(BufferedImage scaledImg, Label lblResult) throws Exception {
        ...
        try {
            ...
            loader.setSource(new File("new1.csv"));
        ...
        saver.setFile(new File("new1.arff"));
        saver.writeBatch();
        ...
        for(Instance i : instances) {
            ...
            double[] readableResult = classifier.distributionForInstance(i);
            for(double r : readableResult) {
